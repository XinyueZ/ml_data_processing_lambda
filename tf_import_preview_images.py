...
#
# If "{R_PATH}/" is not provided, the  "/tmp/.keras/datasets"
# or "/tmp/" is the place to save downloaded file.
...
def plot_images(images_arr):
    ...
    :param images_arr: A list of images which are generated by ImageDataGenerator
    """
...
def generate_images_from_directory(from_directory,
    ...
    return ImageDataGenerator(rescale=rescale).flow_from_directory(from_directory,
...
augmented_images = [gen[0][0][0] for i in range(5)]
